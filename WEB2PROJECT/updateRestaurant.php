                ...
                <div class="box">
                    <div class="itemCard">
                        <form method="POST" action="updateProcess.php" onsubmit="return validateForm()">
                            ...
                            <input type="text" id="rName" class ="form-control" name="restaurantName"  value="<?php echo $_SESSION['restaurantName'] ?>" disabled/>
                            <br><label for="bPrice">Base Price:</label>
                            <input type="text" id="bPrice" class ="form-control" name="basePrice" required value="<?php echo $_SESSION['basePrice'] ?>"/></br>
                            <label for="sOption" style="display: inline;">Service Option: <?php echo $_SESSION['serviceOptions'] ?> </label><br>
                            ...
                            <input type="text" id="location" class ="form-control" name="location" value="<?php echo $_SESSION['location'] ?>" required /></br>
                            <label for="oHours">Opening Hours:</label>
                            <input type="text" id="oHours" class ="form-control" name="openingHours" value="<?php echo $_SESSION['openingHours'] ?>" required /><br>
                            <label for="gReviewRating">Google Review Rating:</label>
                            <input type="text" id="gReviewRating" class ="form-control" name="googleReviewRating" value="<?php echo $_SESSION['googleReviewRatings'] ?>" required /></br>
                            ...
                            <?php echo "Current Image: <br><br><img style='margin:auto' src='data:image;base64," . $_SESSION['picture'] . "'height='200' width='200'><br><br>" ?>
                            </br>
                            <button type="submit" class="btn btn-primary btn-lg" id="btnOk">Confirm</button>
                        </form>
                    </div>
                </div>
            </div>
